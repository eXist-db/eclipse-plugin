...
public interface IResultFrame {
	 ...
	 * define, how much results the result view should show. The return value
	 * gives you the hint, if you cross this limit. After that you can abort to
	 * add more results. This method is thread saved.
	 * 
	 * @param content
	 *            of the query result.
