...
public class XQueryUIPreferenceInitializer extends
	...
	public void initializeDefaultPreferences() {
		...
		PreferenceConverter.setDefault(store,
				IXQueryColorConstants.XQUERY_COMMENT, new RGB(0, 192, 64));
		PreferenceConverter.setDefault(store,
				IXQueryColorConstants.XQUERY_KEYWORD, new RGB(127, 0, 85));
		PreferenceConverter.setDefault(store,
				IXQueryColorConstants.XQUERY_STRING, new RGB(42, 0, 255));
		PreferenceConverter.setDefault(store,
				IXQueryColorConstants.XQUERY_KEYWORD_RETURN, new RGB(192, 192,
						192));

		PreferenceConverter.setDefault(store,
				IXQueryColorConstants.XQUERY_FUNCTION_DEFINITION, new RGB(0, 0,
						0));

		PreferenceConverter.setDefault(store,
				IXQueryColorConstants.XQUERY_ARGUMENT, new RGB(192, 0, 0));

		store.setDefault(IXQueryColorConstants.XQUERY_COMMENT
				+ PreferenceConstants.EDITOR_BOLD_SUFFIX, false);
		store.setDefault(IXQueryColorConstants.XQUERY_COMMENT
				+ PreferenceConstants.EDITOR_ITALIC_SUFFIX, false);

		store.setDefault(IXQueryColorConstants.XQUERY_KEYWORD
				+ PreferenceConstants.EDITOR_BOLD_SUFFIX, true);
		store.setDefault(IXQueryColorConstants.XQUERY_KEYWORD
				+ PreferenceConstants.EDITOR_ITALIC_SUFFIX, false);

		store.setDefault(IXQueryColorConstants.XQUERY_KEYWORD_RETURN
				+ PreferenceConstants.EDITOR_BOLD_SUFFIX, true);
		store.setDefault(IXQueryColorConstants.XQUERY_KEYWORD_RETURN
				+ PreferenceConstants.EDITOR_ITALIC_SUFFIX, false);

		store.setDefault(IXQueryColorConstants.XQUERY_FUNCTION_DEFINITION
				+ PreferenceConstants.EDITOR_BOLD_SUFFIX, false);
		store.setDefault(IXQueryColorConstants.XQUERY_FUNCTION_DEFINITION
				+ PreferenceConstants.EDITOR_ITALIC_SUFFIX, false);

		store.setDefault(IXQueryColorConstants.XQUERY_ARGUMENT
				+ PreferenceConstants.EDITOR_BOLD_SUFFIX, true);
		store.setDefault(IXQueryColorConstants.XQUERY_ARGUMENT
				+ PreferenceConstants.EDITOR_ITALIC_SUFFIX, false);
